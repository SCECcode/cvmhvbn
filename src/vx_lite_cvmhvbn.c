/** 
    vx_lite_cvmhvbn - A command line program to extract velocity values
    from CVM-H VBN. Accepts Geographic Coordinates or UTM Zone 11 
    coordinates.
...
/* Usage function */
void usage() {
  printf("     vx_lite_cvmhvbn - (c) Harvard University, SCEC\n");
  ...
  printf("\tusage: vx_lite_cvmhvbn [-d] [-m dir] [-z dep/elev] < file.in\n\n");
  printf("Flags:\n");
